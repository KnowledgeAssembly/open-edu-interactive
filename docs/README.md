...
**Start here:** [`DESIGN.md`](DESIGN.md) — the overall design, principles, and system-wide decisions (D1-D3).
...
|----------|--------|-----------|
| DESIGN.md | Proposed | Yes — supersedes conflicting envelope/repo/phase forms (see D1-D3) |
...
| engines/geomap/SPEC.md | v1.0.0 | Envelope per D1 (remove `geomap` wrapper in new examples) |
...
For repo layout, phases, and tooling: [`STRUCTURE.md`](STRUCTURE.md). For the living implementation plan: [`PLAN.md`](PLAN.md) (to be created).